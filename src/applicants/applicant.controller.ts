...
export const createApplicant = catchAsync(async (req, res, next) => {
...
export const replyApplicant = catchAsync(async (req, res, next) => {
...
export const allUserApplicants = catchAsync(async (req, res, next) => {
  let applicants: any[];
...
export const deleteApplicant = catchAsync(async (req, res, next) => {
  let applicant;
...
export const getAllApplicants = catchAsync(async (req, res, next) => {
...
export const getApplicant = catchAsync(async (req, res, next) => {
  const { applicantId } = req.params;
...
// Admin Controllers
// exports.getUserApplicants = catchAsync(async (req, res, next) => {});
