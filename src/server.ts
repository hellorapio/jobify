...
// Using plans to limit jobs posted by Companies -- TESTING
// Making reciepts and sending them to emails (PDFs) about subscriptions -- THEY SAY STRIPE HANDLES BUT I WILL HAVE MY TURN

// Handle Emitting New Notifications -- DONE
// Handle Subscribed users to Emit the right notification to the right user -- DONE
// Implementing Notifications -- DONE
